...
<nav class="navbar navbar-dark navbar-expand-md sticky-top py-3" style="background: linear-gradient(black -35%, rgba(255,255,255,0) 100%), rgba(0,0,0,0);">
    <div class="container"><a class="navbar-brand d-flex align-items-center" {{ Route::is('homepage') ? 'data-bss-hover-animate="flash"' : '' }} href="/"><span class="text-light {{ Route::is('homepage') ? 'flash animated' : '' }}" style="font-family: Audiowide, serif;border-bottom: 1px dotted var(--bs-gray-600) ;">samelectronics</span></a><button data-bs-toggle="collapse" class="navbar-toggler" data-bs-target="#navcol-3" style="border-bottom-style: none;color: rgba(255,255,255,0.55);"><span class="text-light visually-hidden">Toggle navigation</span><span class="navbar-toggler-icon text-light"></span></button>
        <div class="collapse navbar-collapse" id="navcol-3">
            <ul class="navbar-nav mx-auto">
                <li class="nav-item">
                    <a class="nav-link {{ Route::is('about') ? 'active' : '' }}" href="{{ route('about') }}" style="font-family: 'B612 Mono', monospace;">{{ __('nav.about_us') }}</a></li>
                <li class="nav-item">
                    <a class="nav-link {{ Route::is('news') ? 'active' : '' }}" href="{{ route('news') }}" style="font-family: 'B612 Mono', monospace;">{{ __('nav.news') }}</a></li>
                <li class="nav-item">
                    <a class="nav-link {{ Route::is('events') ? 'active' : '' }}" href="{{ route('events') }}" style="font-family: 'B612 Mono', monospace;">{{ __('nav.events') }}</a></li>
                <li class="nav-item">
                    <a class="nav-link {{ Route::is('releases') ? 'active' : '' }}" href="{{ route('releases') }}" style="font-family: 'B612 Mono', monospace;">{{ __('nav.releases') }}</a></li>
                <li class="nav-item dropdown">
                    <a class="dropdown-toggle nav-link " aria-expanded="false" data-bs-toggle="dropdown">{{ __('nav.more') }}</a>
                    <div class="dropdown-menu dropdown-menu-dark">
                        <a class="dropdown-item" href="#">{{ __('nav.dropdown_videoart') }}</a>
                        <a class="dropdown-item" href="#">{{ __('nav.dropdown_glitch_art') }}</a>
                        <a class="dropdown-item" href="#">{{ __('nav.dropdown_net_art') }}</a></div>
                </li>
                <li class="nav-item"><a class="nav-link {{ Route::is('contact-us') ? 'active' : '' }}" href="{{ route('contact-us') }}">{{ __('nav.contacts') }}</a></li>
            </ul>
        </div>
        <div class="dropdown"><a class="dropdown-toggle text-lowercase" aria-expanded="false" data-bs-toggle="dropdown" style="color: var(--bs-gray-600);" href="#">{{ app()->getLocale() }}</a>
            <div class="dropdown-menu" style="background: var(--bs-dropdown-link-color);">
                <a class="dropdown-item text-bg-dark {{ app()->getLocale() == 'ru' ? ' active' : '' }}" href="{{ route('change.locale', ['localeName' => 'ru']) }}" style="color: rgb(210,210,210);font-family: 'Noto Sans Carian', sans-serif;">
                    <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 32 32">
                        <path fill="#1435a1" d="M1 11H31V21H1z"></path><path d="M5,4H27c2.208,0,4,1.792,4,4v4H1v-4c0-2.208,1.792-4,4-4Z" fill="#fff">
                        ...
                        </path></svg> {{ __('lang_dropdown.russian') }}</a>
                <a class="dropdown-item text-bg-dark {{ app()->getLocale() == 'en' ? ' active' : '' }}" href="{{ route('change.locale', ['localeName' => 'en']) }}" style="color: rgb(210,210,210);font-family: 'Noto Sans Carian', sans-serif;">
                    <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 32 32">
                    ...
                    </svg>&nbsp;{{ __('lang_dropdown.english') }}</a>
                <a class="dropdown-item text-bg-dark {{ app()->getLocale() == 'de' ? ' active' : '' }}" href="{{ route('change.locale', ['localeName' => 'de']) }}" style="color: rgb(210,210,210);font-family: 'Noto Sans Carian', sans-serif;">
                        <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 32 32">
                            ...
                            <path d="M27,4H5c-2.209,0-4,1.791-4,4V24c0,2.209,1.791,4,4,4H27c2.209,0,4-1.791,4-4V8c0-2.209-1.791-4-4-4Zm3,20c0,1.654-1.346,3-3,3H5c-1.654,0-3-1.346-3-3V8c0-1.654,1.346-3,3-3H27c1.654,0,3,1.346,3,3V24Z" opacity=".15"></path>
                            <path d="M27,5H5c-1.657,0-3,1.343-3,3v1c0-1.657,1.343-3,3-3H27c1.657,0,3,1.343,3,3v-1c0-1.657-1.343-3-3-3Z" fill="#fff" opacity=".2"></path>
                        </svg>&nbsp;{{ __('lang_dropdown.deutsch') }}</a>
            </div>
        </div>
    </div>
</nav>
